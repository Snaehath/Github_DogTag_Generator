...
export interface DogTagPreviewHandle {
  handleDownload: () => Promise<void>;
}

const DogTagPreview = forwardRef<DogTagPreviewHandle, DogTagPreviewProps>(
  ({ user, colorTheme, activeFont, quote }, ref) => {
...
DogTagPreview.displayName = "DogTagPreview";
